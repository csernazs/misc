...
def main():
    ...
    program = CompositeCommand([
        ...
        Iterator(VariableRetriever(Variables.VARIABLE_A), VariableFactory(
            Variables.VARIABLE_B), CompositeCommand([
                Controller(GreaterThanChecker(VariableRetriever(
                    Variables.VARIABLE_B), VariableRetriever(
                    Variables.VARIABLE_M)), VariableSetter(
                    Variables.VARIABLE_M, VariableRetriever(
